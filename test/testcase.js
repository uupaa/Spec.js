...
function testSpec_Vulkan(test, pass, miss) {
    var spec1 = new Spec({ OS: "Android", DEVICE: "SC-02H",   OS_VERSION: 6.0 });
    var spec2 = new Spec({ OS: "Android", DEVICE: "SC-02H",   OS_VERSION: 7.0 });
    var spec3 = new Spec({ OS: "Android", DEVICE: "Nexus 6P", OS_VERSION: 7.0 });
    var spec4 = new Spec({ OS: "Android", DEVICE: "Nexus 5X", OS_VERSION: 7.0 });
    var spec5 = new Spec({ OS: "iOS",     DEVICE: "iPhone 6", OS_VERSION: 9.0 });
...
function testSpec_Metal(test, pass, miss) {
    var spec1 = new Spec({ OS: "iOS", DEVICE: "iPhone 5s", OS_VERSION: 7.0 });
...
function testSpec_FP(test, pass, miss) {
    ...
    console.log("FP_CERT_SHA1", spec1.FP_CERT_SHA1);
    console.log("FP_MALFUNCTION", spec1.FP_MALFUNCTION);

    var result = {
         1: spec1.FP_TLS            === true,
         2: spec1.FP_UTF8           === true,
         3: spec1.FP_COOKIE         === true,
         4: spec1.FP_FLASH_LITE     === 3.1,
         5: spec1.FP_DISPLAY_LONG   === 662,
         6: spec1.FP_DISPLAY_SHORT  === 480,
         7: spec1.FP_CERT_SHA1      === true,
         8: spec1.FP_MALFUNCTION    === true,

        11: spec2.FP_TLS            === true,
        12: spec2.FP_UTF8           === true,
        13: spec2.FP_COOKIE         === true,
        14: spec2.FP_FLASH_LITE     === 2.0,
        15: spec2.FP_DISPLAY_LONG   === 331,
        16: spec2.FP_DISPLAY_SHORT  === 233,
        17: spec2.FP_CERT_SHA1      === true,
        18: spec2.FP_MALFUNCTION    === true,

        21: spec3.FP_TLS            === true,
        22: spec3.FP_UTF8           === true,
        23: spec3.FP_COOKIE         === true,
        24: spec3.FP_FLASH_LITE     === 3.1,
        25: spec3.FP_DISPLAY_LONG   === 700,
        26: spec3.FP_DISPLAY_SHORT  === 471,
        27: spec3.FP_CERT_SHA1      === false,
        28: spec3.FP_MALFUNCTION    === false,
    }
