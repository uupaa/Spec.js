...
//}@dev
    ...
    this["OS_RELASE_VERSION"] = "0.0.0";// OS release version. format "{{Major}},{{Minor}},{{Patch}}"
...
Spec["prototype"] = {
    ...
    "getOSReleaseVersion":  function() { return this["OS_RELASE_VERSION"];},// Spec#getOSReleaseVersion():String
...
Spec["catalog"] = {
    "device": {
        ...
        // --- iOS ---
        "iPhone 6 Plus":    [APPLE,    A8,        800,IVER,1080,1920, 401,  3, 1024,  5,   5.5,  FE_G3LN],
        "iPhone 6":         [APPLE,    A8,        800,IVER, 750,1334, 326,  2, 1024,  5,   4.7,  FE_G3LN],
