...
// --- define ----------------------------------------------
// --- interface -------------------------------------------
function Spec(override) { // @arg Object = {} - { USER_AGENT, SCREEN_WIDTH, SCREEN_HEIGHT, DEVICE_PIXEL_RATIO }
                          // @override.USER_AGENT String = ""
                          // @override.SCREEN_WIDTH Integer = 0
                          // @override.SCREEN_HEIGHT Integer = 0
                          // @override.DEVICE_PIXEL_RATIO Number = 1
...
//{@dev
    ...
    $valid($keys(override, "USER_AGENT,SCREEN_WIDTH,SCREEN_HEIGHT,DEVICE_PIXEL_RATIO"), Spec, "override");
//}@dev

    override = override || {};

    var userAgent        = override["USER_AGENT"] || (global["navigator"] || 0)["userAgent"] || "";
    var screenWidth      = override["SCREEN_WIDTH"] || (global["screen"]  || 0)["width"]     || 0;
    var screenHeight     = override["SCREEN_HEIGHT"] || (global["screen"] || 0)["height"]    || 0;
    var devicePixelRatio = override["DEVICE_PIXEL_RATIO"] || global["devicePixelRatio"]      || 1;
    var deviceInfo = {
...
// --- implement -------------------------------------------
function _createSpecObject(userAgent,    // @arg String
    ...
    return {
        "DEVICE": {
            ...
            "UNKNOWN":      true,       // [Device.js]: Unknown Device.
...
function _detectDeviceID(spec) { // @arg SpecObject
    ...
    //                                                   ~~~~~~
    //                                                  device id
    var deviceInfo = spec["DEVICE"]["INFO"];
    var ua = spec["BROWSER"]["USER_AGENT"];
    var id = ""; // DEVICE.ID
    ...
    case "iOS":             id = _getiOSDeviceID(ua, deviceInfo); break;
    ...
    case "Nexus 7": // -> "Nexus 7 (2013)"
        id = (deviceInfo["DEVICE_PIXEL_RATIO"] || 1) === 2 ? "Nexus 7 (2013)" // Nexus 7 (2013)
...
function _getiOSDeviceID(userAgent,    // @arg String
    ...
    var id = /iPad/.test(userAgent) ? "iPad"
           : /iPod/.test(userAgent) ? "iPod"
                                    : "iPhone";
    var dpr = deviceInfo["DEVICE_PIXEL_RATIO"];
    var longEdge = Math.max(deviceInfo["SCREEN_WIDTH"],
                            deviceInfo["SCREEN_HEIGHT"]); // iPhone 4S: 480, iPhone 5: 568
