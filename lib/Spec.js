...
Spec["catalog"] = {
    "device": {
        ...
        // --- iOS ---
        "iPhone 6 Plus":    [APPLE,    A8,        800,IVER, 414,736,  401,  3,  8,  5,   5.5,  FE_G3LN], // scree{width:414,height:736},inner{width:980,height:1487}
        "iPhone 6":         [APPLE,    A8,        800,IVER, 375,667,  326,  2,  8,  5,   4.7,  FE_G3LN], // scree{width:375,height:667},inner{width:980,height:1461}
        "iPhone 5s":        [APPLE,    A7,        700,IVER, 320,568,  326,  2,  8,  5,     4,  FE_G3L_], // scree{width:320,height:568},inner{width:980,height:1409}
        ...
        "iPad mini Retina": [APPLE,    A7,        700,IVER, 768,1024, 326,  2,  8, 10,   7.9,  FE_G3L_],
        "iPad mini":        [APPLE,    A5,        600,IVER, 768,1024, 132,  1,  4, 10,   7.9,  FE_G3__],
    ...
    //  "Nexus 9":          [GOOGLE,   K1,        443,AVER,1440,2048, 281,  3, 16, 10,   8.9,  FE_G3LN],
...
//      "Nexus 6":          [GOOGLE,   MSM8084,   500,AVER,1080,1920, 423,  0, 24,  5,     6,  FE_G3LN],
...
//{@androidjp
        ...
        // 2014 winter
        "SO-01G":           [SONY,     MSM8974AC, 442,442, 1080,1920, 480,  3, 24,  5,   5.2,  FE_G3LN], // Xperia Z3
        "SO-02G":           [SONY,     MSM8974AC, 442,442,  720,1280, 320,  3, 16,  5,   4.6,  FE_G3LN], // Xperia Z3 Compact
        "SC-01G":           [SAMSUNG,  APQ8084,   442,442, 1440,2560, 480,  3, 24,  5,   5.6,  FE_G3LN], // GALAXY Note Edge
        ...
        // 2014 summer
        "SC-04F":           [SAMSUNG,  MSM8974AC, 442,442, 1080,1920, 480,  3, 16,  5,   5.1,  FE_G3LN], // GALAXY S5, S Browser
        ...
        "SH-01F":           [SHARP,    MSM8974AA, 422,422, 1080,1776, 480,  3, 16,  5,     5,  FE_G3LN], // AQUOS PHONE ZETA SH-01F
        ...
        "KYY23":            [OTHER,    MSM8974AB, 442,442, 1080,1920,   0,  0, 16, 10,   5.0,  FE_G3LN], // KYOCERA URBANO L03
        "KYY24":            [OTHER,    MSM8928,   442,442,  720,1280,   0,  0, 16, 10,   4.5,  FE_G3LN], // KYOCERA TORQUE G01
        ...
        "URBANO L02":       [OTHER,    MSM8960,   422,422,  720,1280, 314,  0, 16, 10,   4.7,  FE_G3LN], // KYOCERA URBANO L02
        "LGL23":            [LG,       MSM8974AA, 422,422,  720,1280, 246,  0, 16, 10,     6,  FE_G3LN], // G Flex LGL23
        "SOL24":            [SONY,     MSM8974AA, 422,422, 1080,1920, 341,  0, 16, 10,   6.4,  FE_G3LN], // Xperia Z Ultra SOL24
        // 2013 winter
        "FJT21":            [OTHER,    MSM8974AA, 422,422, 1600,2560, 300,  0, 16, 10,  10.1,  FE_G3LN], // FUJITSU
        "SOL23":            [SONY,     MSM8974AA, 422,422, 1080,1920, 442,  3, 16, 10,     5,  FE_G3LN], // Xperia Z1
        "SCL22":            [SAMSUNG,  MSM8974AA, 430,430, 1080,1920, 386,  0, 24, 10,   5.7,  FE_G3LN], // S Browser
        "KYL22":            [OTHER,    MSM8974AA, 422,422, 1080,1920, 443,  0, 16,  5,     5,  FE_G3LN], // KYOCERA
        "LGL22":            [LG,       MSM8974AA, 422,422, 1080,1920, 422,  0, 16, 10,   5.2,  FE_G3LN], // isai
        "SHL23":            [SHARP,    MSM8974AA, 422,422, 1080,1920, 460,  0, 16,  5,   4.8,  FE_G3LN],
        "FJL22":            [OTHER,    MSM8974AA, 422,422, 1080,1920, 444,  0, 16, 10,     5,  FE_G3LN], // FUJITSU
...
//{@windowsphone
    ...
    //  "IS12T":            [OTHER,    MSM8655,   750,750,  480,800,    0,  0,  4,  4,     0,  FE_G3__], // FUJITSU
...
//}@firefoxos
    ...
    "soc": {
        ...
        "APQ8084":    [ARM,  2.7,  4,     ADRENO,   "420"           ], // Adreno 420
