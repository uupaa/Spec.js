...
//}@dev
    ...
    this["OS_FIRST_VERSION"] = "0.0.0"; // The OS version of the device at the release date. format "{{Major}},{{Minor}},{{Patch}}"
    this["OS_LAST_VERSION"]  = "0.0.0"; // The OS version of the end of support. format "{{Major}},{{Minor}},{{Patch}}"
    // --- MEMORY / GPU / CPU ---
...
Spec["prototype"]["hasDeviceID"]      = Spec_hasDeviceID;      // Spec#hasDeviceID(deviceID:String):Boolean
Spec["prototype"]["getSpecObject"]    = Spec_getSpecObject;    // Spec#getSpecObject(deviceID:String, env:Object = {}):Object|null
Spec["prototype"]["canDeviceFeature"] = Spec_canDeviceFeature; // Spec#canDeviceFeature(feature:IgnoreCaseString):Boolean
Spec["prototype"]["dump"]             = Spec_dump;             // Spec#dump():Object
Spec["prototype"]["setWebView"]       = Spec_setWebView;       // Spec#setWebView(value:Boolean):this
Spec["prototype"]["prefix"]           = Spec_prefix;           // Spec#prefix(parent:Object, property:String):Object
...
function _setDeviceSpec(that, deviceID) {
  ...
  //that["OS"]
  //that["OS_VERSION"]
    that["OS_FIRST_VERSION"]= _toVersionString(data[2]);
    that["OS_LAST_VERSION"] = _toVersionString(data[3]);
    that["RAM"]             = data[8];
...
function Spec_prefix(parent,     // @arg Object - parent Object
                     property) { // @arg String - target property
                                 // @ret Object - parent[property] or parent["webkit" + Property]
                                 // @desc add vendor prefix
//{@dev
