...
function Spec_create() {
    ...
    return {
        ...
        "NETWORK_CPH":          0,      // [B] Device/Browser connection per host.
                                        //     デバイス(ブラウザ)がホスト毎に同時にリクエストできるコネクションの最大値です
        "NETWORK_MAX_CONNECTION": 0,    // [B] Device/Browser max connections.
                                        //     デバイス(ブラウザ)が同時にリクエストできるコネクションの最大値です
        // --- BROWSER ---
        "USER_AGENT":           "",     // [S] navigator.userAgent string.
                                        //     navigator.userAgent または Spec({ userAgent }) の値です。
        "BROWSER_NAME":         "",     // [B] Browser name. "Chrome", "Firfox", "AndroidBrowser", "IE", "Safari", "WebKit"
                                        //     ブラウザ名です。
