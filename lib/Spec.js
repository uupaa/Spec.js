...
Spec["catalog"] = {
    "device": {
        ...
        "iPad Air 2":       [APPLE,    A8X,       810,IVER, 768,1024, 264,  2,  8, 10,   9.7,  FE_G3L_ | FE_FINGER_PRINT | FE_BAROMETER],
      ...
      //"iPod touch 3":     [APPLE,    CortexA8,  310,511,  320,480,  326,  2,  2,  5,   3.5,  0      ], // iPod touch 32/64GB Model
        ...
        "Nexus 9":          [GOOGLE,   K1,        500,AVER,1536,2048,   0,  0, 16, 10,   8.9,  FE_G3LN],
        ...
        "Nexus 6":          [GOOGLE,   MSM8084,   500,AVER,1440,2560, 493,  3, 24,  5,  5.96,  FE_G3LN],
...
//}@firefoxos
    ...
    "soc": {
        ...
        "A8X":        [ARM64,1.6,  2,     POWER_VR, "G6450"         ],
        // --- Snapdragon ---
    ...
    //  "SC6821":     [ARM,  1.0,  1,     POWER_VR, "SC6821"        ], // Firefox OS, maybe
        ...
        "Z3560":      [ATOM, 1.8,  4,     POWER_VR, "G6430"         ], // Nexus Player
