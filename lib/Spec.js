...
Spec["FEATURE_BROWSER"]  = 0x0400; // spec.FEATURE - Custom browser (S Browser, Kindle)
Spec["FEATURE_NO_STORE"] = 0x0800; // spec.FEATURE - Disable store access (No Google Play)
...
function Spec_create() {
    ...
    return {
        ...
        "BROWSER_NAME":         "",     // [B] Browser name. "Chrome", "Firfox", "Browser", "IE", "Safari", "WebKit"
                                        //     ブラウザ名です。
                                        //     Kindle は "Browser" になります。S Browser は "Chrome" になります。
                                        //     Android WebView は "Browser", Chrome WebView は "Chrome" になります。
        "BROWSER_SUBNAME":      "",     // [B] Brorser sub-name. "" or "S Browser" or "Kindle"
                                        //     ブラウザのサブネームです。"S Browser" または "Kindle" が設定される可能性があります
