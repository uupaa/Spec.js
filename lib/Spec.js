...
//{@dev
    Valid(Valid.type(override, "Object/omit"), Spec, "override");
    Valid(Valid.keys(override, "USER_AGENT,DEVICE_INFO"), Spec, "override");
//}@dev
...
//{@dev
    Valid(Valid.type(userAgent,  "String"), Spec, "override.USER_AGENT");
    Valid(Valid.type(deviceInfo, "Object"), Spec, "override.DEVICE_INFO");
//}@dev
...
if (global["Spec"]) {
    global["Spec_"] = Spec; // secondary
} else {
    global["Spec"]  = Spec; // primary
}
