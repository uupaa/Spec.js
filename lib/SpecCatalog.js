...
- GPU
    ...
    - OpenGL ES support level
        ...
        - OS Version Limit
            - Android 7.0 >= Vulkan 1.0    (NEED GPU driver support)
    ...
    - WebGL support devices http://ja.wikipedia.org/wiki/WebGL
        ...
        - Chrome 30+ && OpenGL ES 3.0+
            - Need GL_ARB_robustness or GL_EXT_robustness supports Video card
        ...
        - Open GL ES 1.1 -> WebGL1.0 Not ready
    - Metal
        - iOS 8.0+
        - A7+ (iPhone 5s, iPad Air, iPad mini 2, iPad mini 3)
        - POWERVR G6430/GX6450/GXA6850/GT7600/GT7800/GT??? (iPhone 7)
    - Vulkan
        - Android 7.0+
        - Adreno 4xx/5xx
        - Tegra K1,X1
...
var H265E       = 0x1000;               // MEDIA: H.265 encoder (Snapdragon 810,     NVIDIA X1, MT6795, A8+)
var H265D       = 0x2000;               // MEDIA: H.265 decoder (Snapdragon 805/808, NVIDIA X1, MT6795, A8+)
var H265        = H265E | H265D;        // MEDIA: H.265 encoder and decoder.
var FORCE_TOUCH = 0x4000;               // DISPLAY: Force touch
var FORCE_CLICK = 0x8000;               // DISPLAY: Force click on link navigation
// --- GPU_TAGS ---
var GLES11      = 0x0001;               // GPU: OpenGL ES 1.1
var GLES20      = 0x0002;               // GPU: OpenGL ES 2.0
var GLES30      = 0x0004;               // GPU: OpenGL ES 3.0
var GLES31      = 0x0008;               // GPU: OpenGL ES 3.1
var GLES32      = 0x0010;               // GPU: OpenGL ES 3.2
var GLES33      = 0x0020;               // GPU: OpenGL ES 3.3
...
var iOS = {
    //                     SOC         RELEASE OS_VERS   DISP1 DISP2 INCH RAM TOUCH DEVICE_TAGS
    // -- iOS Devices ---
    "iPhone 7s":        [ "A10",        1609, "1001-",    414,  736,  5.5, 24,  5,  ARM64 | BLE | NFC | H265 | FORCE_TOUCH | FORCE_CLICK ],
    "iPhone 7":         [ "A10",        1609, "1001-",    375,  667,  4.7, 16,  5,  ARM64 | BLE | NFC | H265 | FORCE_TOUCH | FORCE_CLICK ],
    "iPhone SE":        [ "A9",         1604, "930-",     320,  568,  4.0, 16,  5,  ARM64 | BLE | NFC | H265], // screen{width:320,height:568},inner{width:980,height:1409}
    "iPhone 6s Plus":   [ "A9",         1509, "900-",     414,  736,  5.5, 16,  5,  ARM64 | BLE | NFC | H265 | FORCE_TOUCH | FORCE_CLICK ],
    "iPhone 6s":        [ "A9",         1509, "900-",     375,  667,  4.7, 16,  5,  ARM64 | BLE | NFC | H265 | FORCE_TOUCH | FORCE_CLICK ],
    "iPhone 6 Plus":    [ "A8",         1409, "800-",     414,  736,  5.5,  8,  5,  ARM64 | BLE | NFC | H265 ], // screen{width:414,height:736},inner{width:980,height:1487}
    "iPhone 6":         [ "A8",         1409, "800-",     375,  667,  4.7,  8,  5,  ARM64 | BLE | NFC | H265 ], // screen{width:375,height:667},inner{width:980,height:1461}
    ...
    "iPhone 4s":        [ "A5",         1110, "511-935",  320,  480,  3.5,  4,  5,          BLE       ], // screen{width:320,height:480},inner{width:980,height:1139}
    ...
    "iPad Pro 9.7":     [ "A9X",        1604, "930-",     768, 1024,  9.7, 16, 11,  ARM64 | BLE | NFC | H265 ], // iPad Pro 9.7 inch
    "iPad Pro":         [ "A9X",        1511, "910-",    1024, 1366, 12.9, 32, 11,  ARM64 | BLE | NFC | H265 ], // iPad Pro 12.9 inch
    "iPad Air 2":       [ "A8X",        1410, "810-",     768, 1024,  9.7, 16, 11,  ARM64 | BLE | NFC | H265 ], //
    "iPad Air":         [ "A7",         1311, "700-",     768, 1024,  9.7,  8, 11,  ARM64 | BLE | NFC ], //
    "iPad 4":           [ "A6X",        1211, "600-",     768, 1024,  9.7,  8, 11,          BLE       ], //
    "iPad 3":           [ "A5X",        1203, "510-935",  768, 1024,  9.7,  8, 11,          BLE       ], //
    "iPad 2":           [ "A5",         1103, "430-935",  768, 1024,  9.7,  4, 11,                    ], //
    "iPad":             [ "A4",         1004, "320-511",  768, 1024,  9.7,  2, 11,                    ], //
    "iPad mini 4":      [ "A8",         1509, "900-",     768, 1024,  7.9, 16, 11,  ARM64 | BLE | NFC | H265 ], //
    "iPad mini 3":      [ "A7",         1410, "810-",     768, 1024,  7.9,  8, 11,  ARM64 | BLE       ], //
    "iPad mini 2":      [ "A7",         1311, "700-",     768, 1024,  7.9,  8, 11,  ARM64 | BLE       ], //
    "iPad mini":        [ "A5",         1211, "600-935",  768, 1024,  7.9,  4, 11,          BLE       ], //
    "iPod touch 6":     [ "A8",         1507, "840-",     320,  568,  4.0,  8,  5,          BLE       ], //
    "iPod touch 5":     [ "A5",         1209, "600-935",  320,  568,  4.0,  4,  5,          BLE       ], //
...
//  "Pixel":            [ "???",        16??, "710-",    1080, 1920,  5.0, 32, 10,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // GOOGLE    Google Pixel
//  "Pixel XL":         [ "???",        16??, "710-",    1440, 2560,  5.5, 32, 10,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // GOOGLE    Google Pixel XL
...
//{@devicejp
    ...
    // --- docomo ---
    // 2016 winter
//  "L-01J":            [ "MSM8996",    1702, "700-700", 1440, 2560,  5.2, 32,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // LG        V20 PRO (LG V20 base)(USB Type-C)
//  "DM-01J":           [ "MSM8937",    1702, "601-601",  720, 1280,  5.0, 16,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SHARP     Disney Mobile on docomo
//  "F-01J":            [ "MSM8953",    1612, "601-700", 1080, 1920,  5.5, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // FUJITSU   arrows NX
//  "MO-01J":           [ "MSM8952",    1612, "601-601",  720, 1280,  4.7, 16,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // ZTE       MONO
    "SH-02J":           [ "MSM8937",    1611, "601-700",  720, 1184,  5.0, 16,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SHARP     AQUOS EVER
    "SO-02J":           [ "MSM8996",    1611, "601-700",  720, 1280,  4.6, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SONY      Xperia X Compact
    "SO-01J":           [ "MSM8996",    1611, "601-700", 1080, 1920,  5.2, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SONY      Xperia XZ
//  "F-04J":            [ "MSM8953",    1703, "601-601",  720, 1280,  4.5, 16,  0,                            WEBVIEW           ], // FUJITSU   Silver age model F-04J
//  "F-02J":            [ "MSM8953",    1612, "601-601",  480,  854,  3.0,  8,  0,                            WEBVIEW           ], // FUJITSU   Silver age model F-02J
    "SH-01J":           [ "MSM8909",    1611, "511-511",  540,  960,  3.4,  8,  0,                            WEBVIEW           ], // SHARP     AQUOS ZETA
    "P-01J":            [ "MSM8909",    1611, "511-511",  480,  854,  3.4,  8,  0,                            WEBVIEW           ], // PANASONIC P-smart
    // 2016 summer
    "SC-02H":           [ "MSM8996",    1605, "601-700", 1440, 2560,  5.5, 32,  5,  ARM64 | BLE | NFC | OTG | CHROME_SB | H265  ], // SAMSUNG   Galaxy S7 edge
    "SO-04H":           [ "MSM8996",    1606, "601-700", 1080, 1920,  5.0, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SONY      Xperia X Performance
    "SH-04H":           [ "MSM8996",    1607, "601-700", 1080, 1920,  5.3, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SHARP     AQUOS ZETA
    "F-03H":            [ "MSM8916",    1607, "601-700",  720, 1280,  5.0, 16,  5,  ARM64 | BLE | NFC | OTG | CHROME_WB         ], // FUJITSU   arrows SV
    "DM-02H":           [ "MSM8937",    1607, "601-601", 1080, 1920,  5.2, 16,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SHARP     Disney Mobile on docomo
    "F-04H":            [ "MSM8992",    1607, "601-700", 1600, 2560, 10.5, 24, 10,  ARM64 | BLE | NFC | OTG | CHROME_WB | H265D ], // FUJITSU   arrows Tab
    // 2015 winter
    "SC-01H":           [ "MSM8916",    1511, "511-511",  480,  800,  4.5, 16,  5,  ARM64 | BLE | NFC | OTG | CHROME_SB         ], // SAMSUNG   Galaxy Active neo
    "SO-01H":           [ "MSM8994",    1510, "511-700", 1080, 1920,  5.2, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SONY      Xperia Z5
    "SO-02H":           [ "MSM8994",    1511, "511-700",  720, 1280,  4.6, 16,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SONY      Xperia Z5 Compact
    "SO-03H":           [ "MSM8994",    1511, "511-700", 2160, 3840,  5.5, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SONY      Xperia Z5 Premium
    "SH-01H":           [ "MSM8992",    1510, "511-700", 1080, 1920,  5.3, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265D ], // SHARP     AQUOS ZETA
    "SH-02H":           [ "MSM8992",    1512, "511-700", 1080, 1920,  4.7, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265D ], // SHARP     AQUOS Compact
    "DM-01H":           [ "MSM8992",    1601, "511-511", 1080, 1920,  4.7, 24,  5,  ARM64 | BLE | NFC       | CHROME    | H265D ], // SHARP     Disney Mobile on docomo DM-01H
    "F-01H":            [ "MSM8916",    1510, "511-601",  720, 1280,  5.0, 16,  5,  ARM64 | BLE | NFC       | CHROME_WB         ], // FUJITSU   arrows Fit
    ...
    // 2015 summer
    "SO-03G":           [ "MSM8994",    1506, "502-700", 1080, 1920,  5.2, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME_WB | H265  ], // SONY      Xperia Z4
    "SO-04G":           [ "MSM8974AC",  1506, "500-600",  720, 1280,  4.6, 16,  5,          BLE | NFC | OTG | CHROME_WB         ], // SONY      Xperia A4
    "SO-05G":           [ "MSM8994",    1507, "500-700", 1600, 2560, 10.1, 24, 10,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SONY      Xperia Z4 Tablet
    "SC-04G":           [ "EXYNOS7420", 1504, "502-700", 1440, 2560,  5.1, 24,  5,          BLE | NFC | OTG | CHROME_SB         ], // SAMSUNG   GALAXY S6 Edge
    "SC-05G":           [ "EXYNOS7420", 1504, "502-700", 1440, 2560,  5.1, 24,  5,          BLE | NFC | OTG | CHROME_SB         ], // SAMSUNG   GALAXY S6
    "SH-03G":           [ "MSM8994",    1505, "502-700", 1080, 1920,  5.5, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SHARP     AQUOS ZETA
  ...
  //"SH-05E":           [ "MSM8960",    1302, "404-404",  540,  960,  4.1,  8,  2,                NFC | OTG | CHROME_AB         ], // SHARP     JUNIOR Phone (no WiFi) (no Google Play)
    ...
    // --- au ---
    // 2016 winter
    "SOV34":            [ "MSM8996",    1611, "601-700", 1080, 1920,  5.2, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SONY      Xperia XZ (USB Type-C)
    "LGV34":            [ "MSM8996",    1611, "700-700", 1440, 2560,  5.2, 32,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // LG        isai Beat (LG V20 base)(USB Type-C)
    "SHV37":            [ "MSM8937",    1611, "601-700",  720, 1280,  5.0, 16,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SHARP     AQUOS U
//  "KYV??":            [ "MSM8937",    1612, "601-601",  720, 1280,  5.0, 16,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // KYOCERA   URBANO V03
    "LGT32":            [ "MSM8952",    1612, "601-700", 1200, 1920, 10.1, 16, 10,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // KYOCERA   Qua tab PZ
    // 2016 summer
    "SHF33":            [ "MSM8926",    1607, "444-444",  540,  960,  5.5,  8,  5,          BLE | NFC       | WEBVIEW           ], // SHARP     AQUOS K SHF33
    "SCV33":            [ "MSM8996",    1605, "601-700", 1440, 2560,  5.5, 32,  5,  ARM64 | BLE | NFC | OTG | CHROME_SB | H265  ], // SAMSUNG   Galaxy S7 edge SCV33
    "SOV33":            [ "MSM8996",    1606, "601-700", 1080, 1920,  5.0, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SONY      Xperia X Performance SOV33
    "HTV32":            [ "MSM8996",    1606, "601-700", 1440, 2560,  5.2, 32,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // HTC       HTC 10 HTV32
    "SHV35":            [ "MSM8952",    1606, "601-601",  720, 1280,  5.0, 16,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SHARP     AQUOS U SHV35
    "SHV34":            [ "MSM8996",    1606, "601-700", 1080, 1920,  5.3, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SHARP     AQUOS SERIE SHV34
    "LGV33":            [ "MSM8937",    1607, "601-700", 1080, 1920,  5.2, 16,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // LG        Qua phone PX
    "LGT31":            [ "MSM8952",    1607, "601-700", 1200, 1920,  8.0, 16, 10,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // KYOCERA   Qua tab PX
    // 2016 spring
    ...
    // 2015 winter
    "SCV32":            [ "EXYNOS5433", 1512, "511-700", 1080, 1920,  5.7, 16, 10,  ARM64 | BLE | NFC       | CHROME_SB         ], // SAMSUNG   Galaxy A8 SCV32
    "KYV36":            [ "MSM8916",    1510, "511-511",  720, 1280,  5.0, 16,  5,  ARM64 | BLE | NFC       | CHROME_WB         ], // KYOCERA   DIGNO rafre
    "SOV32":            [ "MSM8994",    1510, "511-700", 1080, 1920,  5.2, 24,  5,  ARM64 | BLE | NFC       | CHROME_WB | H265  ], // SONY      Xperia Z5
    // 2015 spring and summer
    "SCV31":            [ "EXYNOS7420", 1504, "502-700", 1440, 2560,  5.1, 24,  5,          BLE | NFC       | CHROME_SB         ], // SAMSUNG   GALAXY S6 Edge
    "SOV31":            [ "MSM8994",    1506, "500-700", 1080, 1920,  5.2, 24,  5,  ARM64 | BLE | NFC       | CHROME_WB | H265  ], // SONY      Xperia Z4
    "SOT31":            [ "MSM8994",    1507, "502-700", 1600, 2560, 10.1, 24, 10,  ARM64 | BLE | NFC       | CHROME_WB | H265  ], // SONY      Xperia Z4 Tablet
    ...
    "SHV32":            [ "MSM8994",    1506, "502-700", 1080, 1920,  5.5, 24,  5,  ARM64 | BLE | NFC       | CHROME    | H265  ], // SHARP     AQUOS SERIE
    ...
    //                     SOC         RELEASE OS_VERS   DISP1 DISP2 INCH RAM TOUCH DEVICE_TAGS
    // --- SoftBank ---
//  "601HW":            [ "MSM8939",    1703, "601-601", 1200, 1920, 10.1, 16, 10,  ARM64 | BLE | NFC | OTG | CHROME    | H265D ], // HUAWEI    MediaPad T2 PRO
//  "602LV":            [ "MT8735",     1612, "601-601",  800, 1280,  8.0, 16, 10,  ARM64 | BLE | NFC | OTG | CHROME            ], // LENOVO    TAB3
//  "603SH":            [ "MSM8952",    1702, "700-700", 1080, 1920,  4.7, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SHARP     AQUOS Xx3 mini
//  "601SH":            [ "MSM8996",    1612, "601-601", 1080, 1920,  5.3, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SHARP     StarWars (based on AQUOS Xx3)
//  "602SH":            [ "MSM8909",    1610, "511-511",  540,  960,  3.4,  8,  0,                            WEBVIEW           ], // SHARP     AQUOS Keitai 2
    "601SO":            [ "MSM8996",    1611, "601-700", 1080, 1920,  5.2, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SONY      Xperia XZ
    "509SH":            [ "MSM8952",    1609, "601-601",  720, 1280,  5.0, 16,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SHARP     Simple SmartPhone 3
    "507SH":            [ "MSM8952",    1607, "601-700",  720, 1280,  5.0, 16,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SHARP     Android One
    "502SO":            [ "MSM8996",    1606, "601-601", 1080, 1920,  5.0, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SONY      Xperia X Performance 503SO
    "503KC":            [ "MSM8916",    1606, "601-601",  720, 1280,  5.0, 16,  5,  ARM64 | BLE             | CHROME            ], // KYOCERA   DIGNO F (DIGNO E - Y Mobile)
    "506SH":            [ "MSM8996",    1606, "601-601", 1080, 1920,  5.3, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SHARP     AQUOS Xx3
    ...
    "501SO":            [ "MSM8994",    1510, "511-600", 1080, 1920,  5.2, 24,  5,  ARM64 | BLE | NFC       | CHROME    | H265  ], // SONY      Xperia Z5
...
//}@kindle
    ...
    "FTJ152C":          [ "MT6735",     1511, "510-510",  720, 1280,  5.0, 16,  5,  ARM64 | BLE | NFC       | CHROME            ], // FREETEL   SAMURAI MIYABI
    ...
    "Redmi Note 3":     [ "MSM8952",    1602, "511-511", 1080, 1920,  5.5, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // XIAOMI    Redmi Note 3 / Redmi Note 3 Pro (Chrome 51 preinstalled)
//  "ASUS_xxxx":        [ "MSM8996",    1607, "600-600", 1080, 1920,  6.8, 48,  5,  ARM64 | BLE | NFC | OTG | xx        | H265  ], // ASUS      ZenFone 3 Deluxe
//  "ASUS_xxxx":        [ "MSM8953",    1607, "600-600", 1080, 1920,  6.8, 24,  5,  ARM64 | BLE | NFC | OTG | xx        | H265  ], // ASUS      ZenFone 3 Ultra
//  "ASUS_ZE552KL":     [ "MSM8953",    1607, "600-600", 1080, 1920,  5.5, 24,  5,  ARM64 | BLE | NFC | OTG | xx        | H265  ], // ASUS      ZenFone 3
//  "ASUS_ZB551KL":     [ "MSM8928",    1604, "511-511",  720, 1280,  5.5, 16,  5,  ARM64 | BLE | NFC | OTG | xx        | H265  ], // ASUS      ZenFone Go/Go TV
//  "ASUS_ZC550KL":     [ "MSM8916",    1603, "500-500",  720, 1280,  5.5, 16,  5,  ARM64 | BLE | NFC | OTG | xx                ], // ASUS      ZenFone Max
...
var SOC = {
    ...
    "A10":              [ "POWERVR GT7800",    2.3, 2, 2.3, 2 ], // Apple A10. iPhone 7 (CPU: 2.23GHz), TBD: GPU name detection
...
//  "MSM8917":          [ "ADRENO 308",        1.4, 4         ], // Snapdragon 425, ARM64, H265D
    "MSM8937":          [ "ADRENO 505",        1.4, 4, 1.1, 4 ], // Snapdragon 430, ARM64, H265
//  "MSM8940":          [ "ADRENO 505",        1.4, 8         ], // Snapdragon 435, ARM64, H265D
//  "MSM8936":          [ "ADRENO 405",        1.7, 4         ], // Snapdragon 610, ARM64, H265D
    "MSM8939":          [ "ADRENO 405",        1.7, 4         ], // Snapdragon 615/616, ARM64, H265D. KYV31
    "MSM8953":          [ "ADRENO 506",        2.0, 8         ], // Snapdragon 625, ARM64, H265
    "MSM8952":          [ "ADRENO 510",        1.8, 2, 1.2, 4 ], // Snapdragon 650, ARM64, H265
    "MSM8976":          [ "ADRENO 510",        1.8, 4, 1.2, 4 ], // Snapdragon 652, ARM64, H265
...
//  "MSM????":          [ "ADRENO 530",        2.2, 4 ], // Snapdragon 821, ARM64, H265
    ...
    "MT6735":           [ "MALI T720MP2",      1.3, 4 ], // MediaTek, ARM64, FTJ152C
...
var GPU = {
  ...
  //"ADRENO 308":       [     ?,              4, GLES30 ], // Snapdragon 425
    ...
    "ADRENO 505":       [ 200.0,             16, GLES31 ], // Snapdragon 430/435 // TBD: GFLOPS DATA
//  "ADRENO 506":       [     ?,             16, GLES31 ], // Snapdragon 625
    "ADRENO 510":       [ 400.0,             16, GLES31 ], // Snapdragon 625, MSM8952, MSM8976 // TBD: GFLOPS DATA
    "ADRENO 530":       [ 450.0,             16, GLES31 ], // Snapdragon 820/821, Galaxy 7 edge, Google Pixel/XL, Open CL 2.0, Vulkan 1.0, DX11.2
  ...
  //"MALI T880":        [ 190.4 * 1.8,        4, GLES31 ], // Mali-T880
  //"MALI G71":         [     ?,              4, GLES31 ], // Mali-G71
