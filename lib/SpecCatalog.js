...
var ARM64    = 0x10; // CPU: ARM64 (64bit), NVIDIA DENVER (64bit)
...
var Android = {
  ...
  // GT-I9505G":        [ "APQ8064AB",  1306, "422-",    1080, 1920,  5.0, 16,  5,          BLE | NFC | CHROME | SBROWSER ], // Galaxy S4 Google Play Edition
    ...
    "Nexus 6":          [ "APQ8084",    1412, "500-",    1440, 2560,  6.0, 24,  5,          BLE | NFC | CHROME            ], // Nexus 6
...
//  "Mi 4i":            [ "MSM8939",    1504, "502-502", 1080, 1920,  5.0, 16,  5,  ARM64 | BLE | NFC | CHROME            ], // Mi 4i
  ...
  //"ASUS_Z380KL":      [ "MSM8916",    1507, "500-500", 1536, 2048,  8.0, 16, 10,  ATOM  | BLE | NFC | CHROME | CHROMEWB ], // ASUS ZenPad S8.0 (2GB RAM)
...
//{@devicejp
    ...
    // --- docomo ---
    // 2015 summer
    "SO-03G":           [ "MSM8994",    1506, "500-500", 1080, 1920,  5.2, 24,  5,  ARM64 | BLE | NFC | CHROME | CHROMEWB ], // Xperia Z4
    "SO-04G":           [ "MSM8974AC",  1506, "500-500",  720, 1280,  4.6, 16,  5,          BLE | NFC | CHROME | CHROMEWB ], // Xperia A4
    "SO-05G":           [ "MSM8994",    1507, "500-500", 1600, 2560, 10.1, 24, 10,  ARM64 | BLE | NFC | CHROME            ], // Xperia Z4 Tablet
    ...
    "SH-03G":           [ "MSM8994",    1505, "500-500", 1080, 1920,  5.5, 24,  5,  ARM64 | BLE | NFC | CHROME            ], // AQUOS ZETA
    "SH-04G":           [ "MSM8926",    1506, "500-500",  720, 1280,  5.0, 16,  5,          BLE | NFC | CHROME            ], // AQUOS EVER
    "SH-05G":           [ "MSM8994",    1507, "500-500", 1200, 1920,  7.0, 16, 10,  ARM64 | BLE | NFC | CHROME            ], // AQUOS PAD
    "F-04G":            [ "MSM8994",    1505, "500-500", 1440, 2560,  5.2, 24,  5,  ARM64 | BLE | NFC | CHROME | CHROMEWB ], // ARROWS NX
//  "F-05G":            [ "???",        1506, "444-444",  480,  854,  3.4,  0,  0,                      CHROME            ], // ARROWS Galapagosization Android device, NO_LTE
    ...
    // 2014 winter
    "SO-01G":           [ "MSM8974AC",  1410, "444-444", 1080, 1920,  5.2, 24,  5,          BLE | NFC | CHROME | CHROMEWB ], // Xperia Z3
    "SO-02G":           [ "MSM8974AC",  1411, "442-442",  720, 1280,  4.6, 16,  5,          BLE | NFC | CHROME | CHROMEWB ], // Xperia Z3 Compact
    "SC-01G":           [ "APQ8084",    1410, "442-442", 1440, 2560,  5.6, 24,  5,          BLE | NFC | CHROME | SBROWSER ], // GALAXY Note Edge
    ...
    "SO-03F":           [ "MSM8974AB",  1405, "442-442", 1080, 1920,  5.2, 24,  5,          BLE | NFC | CHROME | CHROMEWB ], // Xperia Z2
  ...
  //"SH-05E":           [ "MSM8960",    1302, "404-404",  540,  960,  4.1,  8,  2,                NFC | CHROME | AOSP     ], // JUNIOR Phone (no WiFi) (no Google Play)
    ...
    "SOV31":            [ "MSM8994",    1506, "500-500", 1080, 1920,  5.2, 24,  5,  ARM64 | BLE | NFC | CHROME | CHROMEWB ], // Xperia Z4
    "SOT31":            [ "MSM8994",    1507, "502-502", 1600, 2560, 10.1, 24, 10,  ARM64 | BLE | NFC | CHROME | CHROMEWB ], // Xperia Z4 Tablet
    "HTV31":            [ "MSM8994",    1506, "502-502", 1440, 2560,  5.2, 24, 10,  ARM64 | BLE | NFC | CHROME            ], // HTC J butterfly
    "LGV32":            [ "MSM8992",    1505, "510-510", 1440, 2560,  5.5, 24,  5,          BLE | NFC | CHROME | CHROMEWB ], // isai VL
    "SHV32":            [ "MSM8994",    1506, "502-502", 1080, 1920,  5.5, 24,  5,  ARM64 | BLE | NFC | CHROME            ], // AQUOS SERIE
    ...
    "KYT31":            [ "MSM8939",    1506, "510-510", 1080, 1920,  5.0, 16, 10,  ARM64 | BLE | NFC | CHROME            ], // KYOCERA Qua tab 01
    ...
    "SCL24":            [ "APQ8084",    1410, "444-444", 1440, 2560,  5.6, 24,  5,          BLE | NFC | CHROME | SBROWSER ], // SAMSUNG GALAXY Note Edge
    // 2014 summer
    ...
    //                     SOC          DATE   OS_VERS   DISP1 DISP2 INCH RAM TOUCH TAGS
    // --- SoftBank ---
    "402SO":            [ "MSM8994",    1506, "502-502", 1080, 1920,  5.2, 24,  5,  ARM64 | BLE | NFC | CHROME            ], // Xperia Z4
//  "??":               [ "MSM8994",    1506, "500-500", 1080, 1920,  5.7, 24,  5,  ARM64 | BLE | NFC | CHROME | CHROMEWB ], // SHARP AQUOS Xx
//  "??":               [ "MSM8926",    1507, "500-500",  720, 1280,  5.2, 16,  5,          BLE | NFC | CHROME | CHROMEWB ], // SHARP AQUOS CRYSTAL 2
...
//}@devicejp
//{@kindle
    "KFSAWA":           [ "APQ8084",    1410, "442-442", 1600, 2560,  8.9, 16, 10,          BLE                | CHROMEWB ], // Fire HDX 8.9 (4th) 4G
    "KFSAWI":           [ "APQ8084",    1410, "442-442", 1600, 2560,  8.9, 16, 10,          BLE                | CHROMEWB ], // Fire HDX 8.9 (4th)
...
var SOC = {
    ...
    "APQ8084":          [ "ADRENO 420",        2.5, 4 ], // Snapdragon 805
    ...
    "MSM8916":          [ "ADRENO 306",        1.2, 4 ], // Snapdragon 410, VAIO Phone
    ...
    "MSM8939":          [ "ADRENO 405",        1.7, 4 ], // Snapdragon 615, KYV31
    ...
    "MSM8992":          [ "ADRENO 418",        1.8, 2 ], // Snapdragon 808, LGV32
    "MSM8994":          [ "ADRENO 430",        2.0, 4 ], // Snapdragon 810
    ...
    "T132":             [ "TEGRA T132",        2.2, 4 ], // 64bit K1, Nexus 9
  //"X1":               [ "TEGRA T132",        2.2, 4 ], // 64bit X1, SHILED
...
var GPU = {
    ...
    "POWERVR GX6450":   [ 166.4,        3.1,    16 ], // iPhone 6, iPhone 6 plus, iPad Air 2
    ...
    "ADRENO 430":       [ 144.0 * 1.3,  3.1,    16 ], // Snapdragon 810, SO-03G, SH-03G, F-04G
  ...
  //"TEGRA TX1":        [ 365.0 * 1.3,  3.1,    16 ], // TEGRA X1, SHIELD
