...
var iOS = {
    ...
    "iPhone 4s":        [ "A5",         1110, "511-933",  320,  480,  3.5,  4,  5,          BLE       ], // screen{width:320,height:480},inner{width:980,height:1139}
    ...
    "iPad 3":           [ "A5X",        1203, "510-933",  768, 1024,  9.7,  8, 11,          BLE       ], //
    "iPad 2":           [ "A5",         1103, "430-933",  768, 1024,  9.7,  4, 11,                    ], //
    ...
    "iPad mini":        [ "A5",         1211, "600-933",  768, 1024,  7.9,  4, 11,          BLE       ], //
    "iPod touch 6":     [ "A8",         1507, "840-",     320,  568,  4.0,  8,  5,          BLE       ], //
    "iPod touch 5":     [ "A5",         1209, "600-933",  320,  568,  4.0,  4,  5,          BLE       ], //
...
//{@devicejp
    ...
    // --- docomo ---
    // 2016 summer
    "SC-02H":           [ "MSM8996",    1605, "601-601", 1440, 2560,  5.5, 32,  5,  ARM64 | BLE | NFC | OTG | CHROME_SB | H265  ], // SAMSUNG   Galaxy S7 edge
    "SO-04H":           [ "MSM8996",    1606, "601-601", 1080, 1920,  5.0, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SONY      Xperia X Performance
    "SH-04H":           [ "MSM8996",    1607, "601-601", 1080, 1920,  5.3, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SHARP     AQUOS ZETA
    "F-03H":            [ "MSM8916",    1607, "601-601",  720, 1280,  5.0, 16,  5,  ARM64 | BLE | NFC | OTG | CHROME_WB         ], // FUJITSU   arrows SV
    "DM-02H":           [ "MSM8937",    1607, "601-601", 1080, 1920,  5.2, 16,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SHARP     Disney Mobile on docomo
    "F-04H":            [ "MSM8992",    1607, "601-601", 1600, 2560, 10.5, 24, 10,  ARM64 | BLE | NFC | OTG | CHROME_WB | H265D ], // FUJITSU   arrows Tab
    // 2015 winter
  ...
  //"SH-05E":           [ "MSM8960",    1302, "404-404",  540,  960,  4.1,  8,  2,                NFC | OTG | CHROME_AB         ], // SHARP     JUNIOR Phone (no WiFi) (no Google Play)
    ...
    "SCV33":            [ "MSM8996",    1605, "601-601", 1440, 2560,  5.5, 32,  5,  ARM64 | BLE | NFC | OTG | CHROME_SB | H265  ], // SAMSUNG   Galaxy S7 edge SCV33
    "SOV33":            [ "MSM8996",    1606, "601-601", 1080, 1920,  5.0, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SONY      Xperia X Performance SOV33
    "HTV32":            [ "MSM8996",    1606, "601-601", 1440, 2560,  5.2, 32,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // HTC       HTC 10 HTV32
    "SHV35":            [ "MSM8952",    1606, "601-601",  720, 1280,  5.0, 16,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SHARP     AQUOS U SHV35
    "SHV34":            [ "MSM8996",    1606, "601-601", 1080, 1920,  5.3, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SHARP     AQUOS SERIE SHV34
    "LGV33":            [ "MSM8937",    1607, "601-001", 1080, 1920,  5.2, 16,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // KYOCERA   Qua phone PX
    "LGT31":            [ "MSM8952",    1607, "601-001", 1200, 1920,  8.0, 16, 10,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // KYOCERA   Qua tab PX
    // 2016 spring
...
//  "ADRENO 506":       [     ?,             16, GLES31 ], // Snapdragon 625
    ...
    "ADRENO 530":       [ 450.0,             16, GLES31 ], // Snapdragon 820, Galaxy 7 edge, Open CL 2.0, Vulkan API Supports
