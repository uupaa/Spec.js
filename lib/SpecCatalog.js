...
var iOS = {
    ...
    // -- iOS Devices ---
//  "iPhone 6s Plus":   [ "A9",         1509, "900-",     414,  736,  5.5,  8,  5,  ARM64 | BLE | NFC ],
//  "iPhone 6s":        [ "A9",         1509, "900-",     375,  667,  4.7,  8,  5,  ARM64 | BLE | NFC ],
...
//  "iPad mini 4":      [ "A8",         1509, "900-",     768, 1024,  7.9,  8, 11,  ARM64 | BLE       ], //
...
//{@devicejp
    ...
    // --- docomo ---
    // 2015 summer
    "SO-03G":           [ "MSM8994",    1506, "502-502", 1080, 1920,  5.2, 24,  5,  ARM64 | BLE | NFC | CHROME | CHROMEWB ], // Xperia Z4
    ...
    "SH-05G":           [ "MSM8994",    1507, "502-502", 1200, 1920,  7.0, 16, 10,  ARM64 | BLE | NFC | CHROME            ], // AQUOS PAD
...
//  "F-05G":            [ "???",        1506, "444-444",  480,  854,  3.4,  0,  0,                      CHROME            ], // ARROWS Galapagosization Android device, NO_LTE
    ...
    "SC-01G":           [ "APQ8084",    1410, "442-501", 1440, 2560,  5.6, 24,  5,          BLE | NFC | CHROME | SBROWSER ], // GALAXY Note Edge
