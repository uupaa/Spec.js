...
var CHROME_AB   = CHROME | ABROWSER;
var CHROME_SB   = CHROME | SBROWSER;
var CHROME_WB   = CHROME | WEBVIEW;
...
var OTG         = 0x100;    // DEVICE: USB On-the-Go. USB HOST. Android OS >= 2.3.4
...
//{@devicejp
    ...
    "SO-01H":           [ "MSM8994",    1510, "511-511", 1080, 1920,  5.2, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SONY      Xperia Z5
    "SO-02H":           [ "MSM8994",    1511, "511-511",  720, 1280,  4.6, 16,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SONY      Xperia Z5 Compact
    "SO-03H":           [ "MSM8994",    1511, "511-511", 2160, 3840,  5.5, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SONY      Xperia Z5 Premium
    "SH-01H":           [ "MSM8992",    1510, "511-511", 1080, 1920,  5.3, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265D ], // SHARP     AQUOS ZETA
    "SH-02H":           [ "MSM8992",    1512, "511-511", 1080, 1920,  4.7, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265D ], // SHARP     AQUOS Compact
    "DM-01H":           [ "MSM8992",    1601, "511-511", 1080, 1920,  4.7, 24,  5,  ARM64 | BLE | NFC       | CHROME    | H265D ], // SHARP     Disney Mobile on docomo DM-01H
    "F-01H":            [ "MSM8916",    1510, "511-511",  720, 1280,  5.0, 16,  5,  ARM64 | BLE | NFC       | CHROME_WB         ], // FUJITSU   arrows Fit
    "F-02H":            [ "MSM8992",    1511, "511-511", 1440, 2560,  5.4, 24,  5,  ARM64 | BLE | NFC       | CHROME_WB | H265D ], // FUJITSU   arrows NX
    "d-01H":            [ "KIRIN930",   1511, "511-511", 1200, 1920, 10.1, 16, 10,          BLE | NFC | OTG | CHROME            ], // HUAWEI    dtab d-01H
    // 2015 summer
    "SO-03G":           [ "MSM8994",    1506, "502-502", 1080, 1920,  5.2, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME_WB | H265  ], // SONY      Xperia Z4
    "SO-04G":           [ "MSM8974AC",  1506, "500-500",  720, 1280,  4.6, 16,  5,          BLE | NFC | OTG | CHROME_WB         ], // SONY      Xperia A4
    "SO-05G":           [ "MSM8994",    1507, "500-502", 1600, 2560, 10.1, 24, 10,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SONY      Xperia Z4 Tablet
    "SC-04G":           [ "EXYNOS7420", 1504, "502-502", 1440, 2560,  5.1, 24,  5,          BLE | NFC | OTG | CHROME_SB         ], // SAMSUNG   GALAXY S6 Edge
    "SC-05G":           [ "EXYNOS7420", 1504, "502-502", 1440, 2560,  5.1, 24,  5,          BLE | NFC | OTG | CHROME_SB         ], // SAMSUNG   GALAXY S6
    "SH-03G":           [ "MSM8994",    1505, "500-500", 1080, 1920,  5.5, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME    | H265  ], // SHARP     AQUOS ZETA
    ...
    "F-04G":            [ "MSM8994",    1505, "500-500", 1440, 2560,  5.2, 24,  5,  ARM64 | BLE | NFC | OTG | CHROME_WB | H265  ], // FUJITSU   ARROWS NX
    ...
    // 2014 winter
    "SO-01G":           [ "MSM8974AC",  1410, "444-502", 1080, 1920,  5.2, 24,  5,          BLE | NFC | OTG | CHROME_WB         ], // SONY      Xperia Z3
    "SO-02G":           [ "MSM8974AC",  1411, "442-502",  720, 1280,  4.6, 16,  5,          BLE | NFC | OTG | CHROME_WB         ], // SONY      Xperia Z3 Compact
    "SC-01G":           [ "APQ8084",    1410, "442-501", 1440, 2560,  5.6, 24,  5,          BLE | NFC | OTG | CHROME_SB | H265D ], // SAMSUNG   GALAXY Note Edge
    "SC-02G":           [ "MSM8974AC",  1410, "442-500", 1080, 1920,  5.1, 16,  5,          BLE | NFC | OTG | CHROME_SB         ], // SAMSUNG   GALAXY S5 ACTIVE
    "SC-03G":           [ "MSM8974AC",  1412, "442-502", 1600, 2560,  8.4, 24,  5,          BLE | NFC | OTG | CHROME_SB         ], // SAMSUNG   GALAXY Tab S 8.4
    ...
    // 2014 summer
    "SC-04F":           [ "MSM8974AC",  1405, "442-500", 1080, 1920,  5.1, 16,  5,          BLE | NFC | OTG | CHROME_SB         ], // SAMSUNG   GALAXY S5
  ...
  //"SH-05E":           [ "MSM8960",    1302, "404-404",  540,  960,  4.1,  8,  2,                NFC | OTG | CHROME_AB         ], // SHARP     JUNIOR Phone (no WiFi) (no Google Play)
    ...
    // --- au ---
    // 2015 winter
    "SCV32":            [ "EXYNOS5433", 1512, "511-511", 1080, 1920,  5.7, 16, 10,  ARM64 | BLE | NFC       | CHROME_SB         ], // SAMSUNG   Galaxy A8 SCV32
    "KYV36":            [ "MSM8916",    1510, "511-511",  720, 1280,  5.0, 16,  5,  ARM64 | BLE | NFC       | CHROME_WB         ], // KYOCERA   DIGNO rafre
    "SOV32":            [ "MSM8994",    1510, "511-511", 1080, 1920,  5.2, 24,  5,  ARM64 | BLE | NFC       | CHROME_WB | H265  ], // SONY      Xperia Z5
    // 2015 spring and summer
    "SCV31":            [ "EXYNOS7420", 1504, "502-502", 1440, 2560,  5.1, 24,  5,          BLE | NFC       | CHROME_SB         ], // SAMSUNG   GALAXY S6 Edge
    "SOV31":            [ "MSM8994",    1506, "500-500", 1080, 1920,  5.2, 24,  5,  ARM64 | BLE | NFC       | CHROME_WB | H265  ], // SONY      Xperia Z4
    "SOT31":            [ "MSM8994",    1507, "502-502", 1600, 2560, 10.1, 24, 10,  ARM64 | BLE | NFC       | CHROME_WB | H265  ], // SONY      Xperia Z4 Tablet
    "HTV31":            [ "MSM8994",    1506, "502-502", 1440, 2560,  5.2, 24, 10,  ARM64 | BLE | NFC       | CHROME    | H265  ], // HTC       HTC J butterfly
    "LGV32":            [ "MSM8992",    1505, "510-510", 1440, 2560,  5.5, 24,  5,  ARM64 | BLE | NFC       | CHROME_WB | H265D ], // LG        isai VL
    ...
    "SCT21":            [ "MSM8974AC",  1412, "444-502", 1600, 2560, 10.5, 24,  5,          BLE | NFC       | CHROME_SB         ], // SAMSUNG   GALAXY Tab S
    ...
    "SCL24":            [ "APQ8084",    1410, "444-501", 1440, 2560,  5.6, 24,  5,          BLE | NFC       | CHROME_SB | H265D ], // SAMSUNG   GALAXY Note Edge
    // 2014 summer
    ...
    "HTL23":            [ "MSM8974AC",  1408, "442-444", 1080, 1920,  5.0, 16,  5,          BLE | NFC       | CHROME_WB         ], // HTC       HTC J butterfly. ABROWSER -> OS Update -> WEBVIEW 
    ...
    "SCL23":            [ "MSM8974AC",  1405, "442-500", 1080, 1920,  5.1, 16,  5,          BLE | NFC       | CHROME_SB         ], // SAMSUNG   Galaxy S5
    ...
    //                     SOC          DATE   OS_VERS   DISP1 DISP2 INCH RAM TOUCH TAGS
    // --- SoftBank ---
//  "NP504SH":          [               1512, "511-511",  540,  960,  3.4,  8,  0,                            WEBVIEW           ], // SHARP     AQUOS 504SH
//  "NP501SH":          [               1512, "511-511",  540,  960,  3.4,  8,  0,                            WEBVIEW           ], // SHARP     AQUOS Keitai
    ...
    "404SC":            [ "EXYNOS7420", 1505, "502-502", 1440, 2560,  5.1, 24,  5,          BLE | NFC       | CHROME_SB         ], // SAMSUNG   GALAXY S6 Edge
