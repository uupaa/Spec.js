...
//var CONSOLE   = 0x0010; // DEVICE     | Console/Game device
var ARM         = 0x0020; //        SOC | ARM, ARM64
...
var DEVICE = {
    ...
    "iPhone 4S":        [ "A5",        "511-",     320,  480,  3.5,  4,  5,  IOS,     LE,         SAFARI          ], // scree{width:320,height:480},inner{width:980,height:1139}
    ...
    "iPad 2":           [ "A5",        "430-",     768, 1024,  9.7,  4, 11,  IOS,     LE,         SAFARI          ],
    ...
    "iPad mini":        [ "A5",        "600-",     768, 1024,  7.9,  4, 11,  IOS,     LE,         SAFARI          ],
    "iPod touch 5":     [ "A5",        "600-",     320,  568,  4.0,  4,  5,  IOS,     LE,         SAFARI          ],
  ...
  // GT-I9505G":        [ "APQ8064AB", "422-",    1080, 1920,  5.0, 16,  5,  0,       0,          CHROME|SBROWSER ], // SAMSUNG Galaxy S4 Google Play Edition
    ...
    "Nexus Player":     [ "Z3560",     "500-",    1080, 1920,  0.0,  0,  0,  0,       0,          0               ], // Nexus Player (like a console device)
...
//{@devicejp
    // --- docomo ---
    // 2015 spring
//  "SC-04G":           [ "EXYNOS7420","502-502", 1440, 2560,  5.1, 24,  5,  0,       0,          CHROME|SBROWSER ], // 2015-04-10 GALAXY S6
//  "SC-05G":           [ "EXYNOS7420","502-502", 1440, 2560,  5.1, 24,  5,  0,       0,          CHROME|SBROWSER ], // 2015-04-10 GALAXY S6 Edge
    // 2014 winter
