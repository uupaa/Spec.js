...
var Android = {
  ...
  // GT-I9505G":        [ "APQ8064AB",  1306, "422-",    1080, 1920,  5.0, 16,  5,          BLE | NFC | CHROME | SBROWSER ], // Galaxy S4 Google Play Edition
    ...
    "Nexus 10":         [ "EXYNOS5250", 1211, "420-511", 1600, 2560, 10.0, 16,  5,                NFC | CHROME            ], // Nexus 10
    ...
    "Nexus 7":          [ "T30L",       1207, "411-511",  800, 1280,  7.0,  8,  5,                NFC | CHROME            ], // Nexus 7 (2012)
    ...
    "Nexus 4":          [ "APQ8064",    1211, "420-510",  768, 1280,  4.7, 16,  5,          BLE | NFC | CHROME            ], // Nexus 4
...
//{@devicejp
    ...
    // --- docomo ---
    // 2015 winter
    "SC-01H":           [ "MSM8916",    1511, "511-511",  480,  800,  4.5, 16,  5,  ARM64 | BLE | NFC | CHROME | SBROWSER         ], // Galaxy Active neo
    "SO-01H":           [ "MSM8994",    1510, "511-511", 1080, 1920,  5.2, 24,  5,  ARM64 | BLE | NFC | CHROME            | H265  ], // Xperia Z5
    "SO-02H":           [ "MSM8994",    1511, "511-511",  720, 1280,  4.6, 16,  5,  ARM64 | BLE | NFC | CHROME            | H265  ], // Xperia Z5 Compact
    "SO-03H":           [ "MSM8994",    1511, "511-511", 2160, 3840,  5.5, 24,  5,  ARM64 | BLE | NFC | CHROME            | H265  ], // Xperia Z5 Premium
    "SH-01H":           [ "MSM8992",    1510, "511-511", 1080, 1920,  5.3, 24,  5,  ARM64 | BLE | NFC | CHROME            | H265D ], // AQUOS ZETA
    "SH-02H":           [ "MSM8992",    1512, "511-511", 1080, 1920,  4.7, 24,  5,  ARM64 | BLE | NFC | CHROME            | H265D ], // AQUOS Compact
    "DM-01H":           [ "MSM8992",    1601, "511-511", 1080, 1920,  4.7, 24,  5,  ARM64 | BLE | NFC | CHROME            | H265D ], // Disney Mobile on docomo DM-01H
    "F-01H":            [ "MSM8916",    1510, "511-511",  720, 1280,  5.0, 16,  5,  ARM64 | BLE | NFC | CHROME | CHROMEWB         ], // arrows Fit
    "F-02H":            [ "MSM8992",    1511, "511-511", 1440, 2560,  5.4, 24,  5,  ARM64 | BLE | NFC | CHROME | CHROMEWB | H265D ], // arrows NX
//  "d-01H":            [ "KIRIN930",   1511, "511-511", 1200, 1920, 10.1, 16, 10,        | BLE | NFC | CHROME                    ], // dtab d-01H
    // 2015 summer
    ...
    "SO-05G":           [ "MSM8994",    1507, "500-502", 1600, 2560, 10.1, 24, 10,  ARM64 | BLE | NFC | CHROME            | H265  ], // Xperia Z4 Tablet
    ...
    "F-05G":            [ "MSM8226",    1506, "444-444",  480,  854,  3.4,  3,  0,                               CHROMEWB         ], // ARROWS Galapagosization Android device, NO_LTE
    ...
    "SC-03G":           [ "MSM8974AC",  1412, "442-502", 1600, 2560,  8.4, 24,  5,          BLE | NFC | CHROME | SBROWSER ], // GALAXY Tab S 8.4
    "SH-01G":           [ "MSM8974AB",  1411, "442-502", 1080, 1920,  5.5, 16,  5,          BLE | NFC | CHROME            ], // AQUOS ZETA SH-01G
    "SH-02G":           [ "MSM8974AB",  1411, "442-442", 1080, 1920,  5.5, 16,  5,          BLE | NFC | CHROME            ], // Disney Mobile on docomo SH-02G
    "F-02G":            [ "MSM8974AB",  1411, "442-502", 1440, 2560,  5.2, 24,  5,          BLE | NFC | CHROME | CHROMEWB ], // ARROWS NX F-02G
    ...
    "SO-05F":           [ "MSM8974AB",  1405, "442-502", 1200, 1920, 10.1, 24,  5,          BLE | NFC | CHROME | AOSP     ], // Xperia Z2 Tablet
    "SH-04F":           [ "MSM8974AB",  1405, "442-502", 1080, 1920,  5.4, 16,  5,          BLE | NFC | CHROME | CHROMEWB ], // AQUOS ZETA SH-04F
    "SH-05F":           [ "MSM8974AA",  1405, "422-422", 1080, 1920,  5.0, 16,  5,                NFC | CHROME | AOSP     ], // Disney Mobile on docomo SH-05F
    "SH-06F":           [ "MSM8974AB",  1406, "442-442", 1200, 1920,  7.0, 16,  5,          BLE | NFC | CHROME | CHROMEWB ], // AQUOS PAD SH-06F
    "F-05F":            [ "MSM8974AB",  1405, "442-502", 1080, 1920,  5.0, 16,  5,          BLE | NFC | CHROME | CHROMEWB ], // ARROWS NX F-05F
    "F-06F":            [ "MSM8926",    1407, "442-442",  720, 1280,  4.5, 16,  5,          BLE | NFC |          CHROMEWB ], // Silver age model F-06F
    // 2013 winter
    "L-01F":            [ "MSM8974AA",  1310, "422-422", 1080, 1776,  5.2, 16,  5,                NFC | CHROME | AOSP     ], // LG G2
    "SC-01F":           [ "MSM8974AA",  1310, "430-500", 1080, 1920,  5.7, 16,  5,          BLE | NFC | CHROME | SBROWSER ], // GALAXY Note 3
    "SC-02F":           [ "MSM8974AA",  1310, "430-500", 1080, 1920,  5.0, 16,  5,          BLE | NFC | CHROME | SBROWSER ], // GALAXY J
    ...
    "SC-04E":           [ "APQ8064T",   1305, "422-501", 1080, 1920,  5.0, 16,  5,                NFC | CHROME | SBROWSER ], // Galaxy S4
  ...
  //"SH-05E":           [ "MSM8960",    1302, "404-404",  540,  960,  4.1,  8,  2,                NFC | CHROME | AOSP     ], // JUNIOR Phone (no WiFi) (no Google Play)
    ...
    // --- au ---
    // 2015 winter
    "SCV32":            [ "EXYNOS5433", 1512, "511-511", 1080, 1920,  5.7, 16, 10,  ARM64 | BLE | NFC | CHROME | SBROWSER         ], // Galaxy A8 SCV32
    "KYV36":            [ "MSM8916",    1510, "511-511",  720, 1280,  5.0, 16,  5,  ARM64 | BLE | NFC | CHROME | CHROMEWB         ], // DIGNO rafre
    "SOV32":            [ "MSM8994",    1510, "511-511", 1080, 1920,  5.2, 24,  5,  ARM64 | BLE | NFC | CHROME | CHROMEWB | H265  ], // Xperia Z5
    ...
    "LGV32":            [ "MSM8992",    1505, "510-510", 1440, 2560,  5.5, 24,  5,  ARM64 | BLE | NFC | CHROME | CHROMEWB | H265D ], // isai VL
    ...
    "LGV31":            [ "MSM8974AC",  1412, "442-502", 1440, 2560,  5.5, 24,  5,          BLE | NFC | CHROME | CHROMEWB ], // isai VL
    "KYV31":            [ "MSM8974AB",  1412, "444-444", 1080, 1920,  5.0, 16,  5,          BLE | NFC | CHROME            ], // URBANO V01
    "SOL26":            [ "MSM8974AC",  1410, "444-502", 1080, 1920,  5.2, 24,  5,          BLE | NFC | CHROME | CHROMEWB ], // Xperia Z3
    ...
    "SOT21":            [ "MSM8974AB",  1407, "442-502", 1200, 1920, 10.1, 24,  5,          BLE | NFC | CHROME | AOSP     ], // Xperia Z2 Tablet
    ...
    "SOL25":            [ "MSM8974AB",  1405, "442-502", 1080, 1920,  5.0, 24,  5,          BLE | NFC | CHROME | AOSP     ], // Xperia ZL2
    ...
    //                     SOC          DATE   OS_VERS   DISP1 DISP2 INCH RAM TOUCH TAGS
    // --- SoftBank ---
//  "NP504SH":          [               1512, "511-511",  540,  960,  3.4,  8,  0,                               CHROMEWB         ], // AQUOS 504SH
//  "NP501SH":          [               1512, "511-511",  540,  960,  3.4,  8,  0,                               CHROMEWB         ], // AQUOS Keitai
    "503SO":            [ "MSM8994",    1510, "511-511", 1080, 1920,  5.2, 24,  5,  ARM64 | BLE | NFC | CHROME            | H265  ], // Xperia Z5
    "502SH":            [ "MSM8992",    1511, "511-511", 1080, 1920,  5.3, 24,  5,  ARM64 | BLE | NFC | CHROME            | H265D ], // AQUOS Xx2 (based on SH-01H)
    "503SH":            [ "MSM8992",    1601, "511-511", 1080, 1920,  4.7, 24,  5,  ARM64 | BLE | NFC | CHROME            | H265D ], // AQUOS Xx2 mini (based on SH-02H)
    "501LV":            [ "MT8735",     1511, "502-502",  800, 1280,  8.0, 16, 10,  ARM64 | BLE | NFC | CHROME                    ], // Lenovo TAB2 (based on TAB 2 A8)
    "503HW":            [ "KIRIN620",   1510, "500-500",  720, 1280,  5.0, 16,  5,          BLE       | CHROME                    ], // LUMIERE 503HW (based on Huawei P8 Lite)
    "402SO":            [ "MSM8994",    1506, "502-502", 1080, 1920,  5.2, 24,  5,  ARM64 | BLE | NFC | CHROME            | H265  ], // Xperia Z4
    ...
    "401SO":            [ "MSM8974AC",  1411, "444-502", 1080, 1920,  5.2, 24,  5,          BLE | NFC | CHROME | CHROMEWB ], // Xperia Z3
  ...
  //"EM01L":            [ "MSM8974AA",  1311, "440-440", 1080, 1920,  5.0, 16,  5,          BLE | NFC | CHROME            ], // E-Mobile Nexus 5
    ...
    "WX04K":            [ "APE5R",      1206, "234-411",  480,  800,  4.0,  8,  2,                      CHROME | AOSP     ], // KYOCERA, 2017-03 STOP 3G
    ...
    "DM013SH":          [ "MSM8255",    1212, "404-404",  480,  854,  3.7,  8,  2,                      CHROME | AOSP     ], // SHARP, 2017-03 STOP 3G
    "SBM107SHB":        [ "MSM8255",    1209, "404-404",  480,  854,  3.7,  8,  2,                               AOSP     ], // SHARP
    "WX06K":            [ "APE5R",      1208, "234-234",  480,  800,  3.5,  4,  2,                               AOSP     ], // KYOCERA, 2017-03 STOP 3G
    ...
    "SBM104SH":         [ "OMAP4460",   1202, "403-403",  720, 1280,  4.5,  8,  2,                               AOSP     ], // SHARP, 2017-03 STOP 3G
    "DM012SH":          [ "MSM8255",    1202, "235-235",  540,  960,  4.0,  4,  2,                               AOSP     ], // SHARP, 2017-03 STOP 3G
    ...
    "DM011SH":          [ "MSM8255",    1112, "235-235",  480,  854,  3.4,  4,  2,                               AOSP     ], // SHARP, 2017-03 STOP 3G
    "SBM101SH":         [ "MSM8255",    1111, "235-235",  480,  854,  3.4,  4,  2,                               AOSP     ], // SHARP
    "DM010SH":          [ "MSM8255",    1110, "234-234",  540,  960,  4.0,  4,  2,                               AOSP     ], // SHARP, 2017-03 STOP 3G
  ...
  //"SGP412JP":         [ "APQ8074",    1401, "420-420", 1080, 1920,  6.4, 16,  5,                NFC | CHROME            ], // Xperia Z Ultra WiFi Edition
    ...
    // --- SIM FREE DEVICES ---
    // 2015
  //"???":              [ "MSM8974AB",  1510, "442-510", 1080, 1920,  5.2, 16,  5,          BLE | NFC | CHROME            ], // HTC Desire EYE
  //"???":              [ "MSM8916",    1510, "444-510",  720, 1280,  5.0, 16,  5,  ARM64 | BLE | NFC | CHROME            ], // HTC Desire 626 (Snapdragon 410 version)
  //"???":              [ "MT6752",     1510, "444-510",  720, 1280,  5.0, 16,  5,  ARM64 | BLE | NFC | CHROME            ], // HTC Desire 626 (MT6752 version)
