...
//{@devicejp
    ...
    // --- docomo ---
    // 2015 winter
//  "SC-01H":           [ "MSM8916",    1511, "511-511",  480,  800,  4.5, 16,  5,  ARM64 | BLE | NFC |                           ], // Galaxy Active neo
...
//  "F-02H":            [ "MSM8992",    1511, "511-511", 1440, 2560,  5.4, 24,  5,  ARM64 | BLE | NFC |                   | H265D ], // arrows NX
//  "d-01H":            [ "KIRIN930",   1511, "511-511", 1200, 1920, 10.1, 16, 10,        | BLE | NFC |                           ], // dtab d-01H
    // 2015 summer
...
//  "F-05G":            [ "???",        1506, "444-444",  480,  854,  3.4,  0,  0,                      CHROME                    ], // ARROWS Galapagosization Android device, NO_LTE
  ...
  //"SH-05E":           [ "MSM8960",    1302, "404-404",  540,  960,  4.1,  8,  2,                NFC | CHROME | AOSP     ], // JUNIOR Phone (no WiFi) (no Google Play)
    ...
    // --- au ---
    // 2015 winter
    "SOV32":            [ "MSM8994",    1510, "511-511", 1080, 1920,  5.2, 24,  5,  ARM64 | BLE | NFC | CHROME            | H265  ], // Xperia Z5
