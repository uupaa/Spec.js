...
//  "DM-01H":           [ "MSM8992",    1601, "511-511", 1080, 1920,  4.7, 24,  5,  ARM64 | BLE | NFC |                   | H265D ], // Disney Mobile on docomo DM-01H
...
//  "F-05G":            [ "???",        1506, "444-444",  480,  854,  3.4,  0,  0,                      CHROME                    ], // ARROWS Galapagosization Android device, NO_LTE
  ...
  //"SH-05E":           [ "MSM8960",    1302, "404-404",  540,  960,  4.1,  8,  2,                NFC | CHROME | AOSP     ], // JUNIOR Phone (no WiFi) (no Google Play)
    ...
    "LGV31":            [ "MSM8974AC",  1412, "442-500", 1440, 2560,  5.5, 24,  5,          BLE | NFC | CHROME | CHROMEWB ], // isai VL
    ...
    "LGL24":            [ "MSM8974AC",  1407, "442-500", 1440, 2560,  5.5, 16,  5,          BLE | NFC | CHROME | CHROMEWB ], // LG isai FL
    // 2014 spring
...
//  "xxxxx":            [ "MT8735",     1511, "50?-50?",  800, 1280,  8.0,  8, 10,  ARM64 | BLE | NFC | CHROME                    ], // Lenovo TAB2 (based on TAB 2 A8)
...
var SOC = {
    ...
    "A9X":              [ "POWERVR GT7800",    2.0, 3 ], // Apple A9X. iPad Pro
